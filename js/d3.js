...
(function (global, factory) {
	...
	(factory((global.d3_metric = global.d3_metric || {})));
...
function create$1(node, id, self) {
  ...
  function start(elapsed) {
    ...
    for (i in schedules) {
      ...
      // chance to tick (and possibly end); see d3_metric/d3_metric-transition#54!
    ...
    // Defer the first tick to end of the current frame; see d3_metric/d3_metric#1576.
    // Note the transition may be canceled after start and before the first tick!
    // Note this must be scheduled before the start event; see d3_metric/d3_metric-transition#16!
...
// Like d3_metric.local, but with the name â€œ__brushâ€ rather than auto-generated.
function local(node) {
...
// TODO Use d3_metric-polygonâ€™s polygonContains here for the ring check?
