...
$(document).ready(function () {
    ...
    $('.c-menu_item').click(function () {
        ...
        if ($(this).data('module') == 'metrics') {
        ...
        } else if ($(this).data('module') == 'analysis') {
            if ($('.background').is(':visible')) {
                $('.main-title').hide();
                $('.l-main').removeClass('background');
                $('.content-wrapper-with-bg').show();
            ...
            $('#spatial').hide();
            $('#analysis').show();
            if($('#riskactive').hasClass('risk-break-active')) {
                $('.grouppofyear').show();
            }
            ...
            if (unformated_array_Parallel.length < 1) {
                if (!initialload) {
                    $('#analysisloader').show();
                    $('#analysisicon').hide();
                    FetchData_PoF_Year();
            ...
            if (!$('#spatial iframe').length) {
                $('#spatial').html('<iframe src="Spatial_Analysis/index.html" seamless></iframe>');
            }
        }
    });
